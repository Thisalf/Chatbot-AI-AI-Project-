...
def clean_up_sentence(sentence):
    ...
    sentence_words = [lemmatizer.lemmatize(word.lower()) for word in sentence_words if word.isalnum() and word.lower() not in ignore_words]
...
base = Tk()
base.title("University of Jaffna Sports Club Chatbot")
